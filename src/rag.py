...
PERSONAS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "system_instructions": (
            ...
            "If the conversation is focused exclusively on Dr. Antúnez's neuroscience research or academic background and has not yet touched on his industry work, find a natural moment to mention that this foundation connects to his current production work — for example, his MLOps pipelines, Azure data engineering, GenAI systems, or ETL solutions. Do this only when it fits the flow of the answer, not as a fixed closing sentence. If the question already covers his industry or technical work, skip this entirely. Never use a formula or repeat the same phrasing. "
    ...
    "es": {
        ...
        "system_instructions": (
            ...
            "Si la conversación está centrada exclusivamente en la investigación en neurociencia o la trayectoria académica del Dr. Antúnez y aún no ha tocado su trabajo en la industria, busca un momento natural para mencionar que esa base conecta con su trabajo actual en producción — por ejemplo, sus pipelines de MLOps, ingeniería de datos en Azure, sistemas de GenAI o soluciones ETL. Hazlo solo cuando encaje con el flujo de la respuesta, no como una frase de cierre fija. Si la pregunta ya cubre su trabajo técnico o en la industria, omite esto por completo. Nunca uses una fórmula ni repitas la misma expresión. "
